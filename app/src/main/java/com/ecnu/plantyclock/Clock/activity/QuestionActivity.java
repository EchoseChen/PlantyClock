        ...
        switch (v.getId()){
            case R.id.set_calculate_que_btn:
                ...
                if (flag!= null){
                    ...
                    Toast.makeText(com.ecnu.plantyclock.Clock.activity.QuestionActivity.this, "新的随机问题设置好啦^_^", Toast.LENGTH_SHORT).show();
                }else {
                    int ID = db.addQuestion(new QuestionModel("flag_calculate", "000", alarmID));
                    Toast.makeText(com.ecnu.plantyclock.Clock.activity.QuestionActivity.this, "随机问题设置好啦^_^", Toast.LENGTH_SHORT).show();
                }
                onBackPressed();
                break;
            ...
            case R.id.question_sure_btn:
                ...
                if (diyAnswer.isEmpty()||diyQuestion.isEmpty()){
                    Toast.makeText(com.ecnu.plantyclock.Clock.activity.QuestionActivity.this, "(＞﹏＜)，问题和答案都不能为空", Toast.LENGTH_SHORT).show();
                }else {
                    if (flag != null){
                        QuestionModel qm = db.getQuestion(alarmID);
                        ...
                        Toast.makeText(com.ecnu.plantyclock.Clock.activity.QuestionActivity.this, "自定义问题设置好啦^_^", Toast.LENGTH_SHORT).show();
                    }
                    onBackPressed();
                }
                break;
