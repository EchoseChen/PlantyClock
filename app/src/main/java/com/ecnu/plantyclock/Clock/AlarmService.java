...
public class AlarmService extends Service {
    ...
    public void onDestroy() {
        Intent service = new Intent(this, com.ecnu.plantyclock.Clock.AlarmService.class);
    ...
    public static class MyBinder extends Binder {
        ...
        public void cancelAlarm(AlarmModel alarm, int id, Context context){
            ...
            if (repeat.equals("每天")||repeat.equals("只响一次")){
                PendingIntent pi = PendingIntent.getBroadcast(context, id,
                        new Intent(context, com.ecnu.plantyclock.Clock.MyAlarmReceiver.class), 0);
        ...
        private PendingIntent getIntent(int config, Context context, int id, int flagDayOfWeek) {
            ...
            Intent intent = new Intent(context, com.ecnu.plantyclock.Clock.MyAlarmReceiver.class);
            intent.putExtra(com.ecnu.plantyclock.Clock.MyAlarmReceiver.ID_FLAG, Integer.toString(id));
    ...
    public static class RebootReceiver extends BroadcastReceiver {
        ...
        private int mID;
        private com.ecnu.plantyclock.Clock.AlarmService.MyBinder binder = new MyBinder();
        @Override
