package com.ecnu.plantyclock.Clock.data;
...
public class MyAlarmDataBase {
    ...
    private com.ecnu.plantyclock.Clock.data.MyAlarmOpenHelper myAlarmOpenHelper;
    ...
    public MyAlarmDataBase(Context context){
        com.ecnu.plantyclock.Clock.data.MyAlarmOpenHelper openHelper = new com.ecnu.plantyclock.Clock.data.MyAlarmOpenHelper(context,DATABASE_NAME,null,DATABASE_VERSION);
