...
public class AddAlarmActivity extends AppCompatActivity implements
    ...
    public void selectWake(View v){
        ...
        builder.setSingleChoiceItems(items, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == 1) {
                    Intent i = new Intent(com.ecnu.plantyclock.Clock.activity.AddAlarmActivity.this, QuestionActivity.class);
    ...
    private void saveAlarm() {
        ...
        intent2.setClass(com.ecnu.plantyclock.Clock.activity.AddAlarmActivity.this, com.ecnu.plantyclock.activities.StyleActivity.class);
