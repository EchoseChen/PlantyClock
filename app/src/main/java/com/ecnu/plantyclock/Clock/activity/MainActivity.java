 ...
 * Use for test the function of the Clock part
 */
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.mOverFlowImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    cancelAlarm(com.ecnu.plantyclock.Clock.activity.MainActivity.this, id, alarm);

                    Toast.makeText(com.ecnu.plantyclock.Clock.activity.MainActivity.this, "已删除闹钟", Toast.LENGTH_SHORT).show();
...
//        }
                ...
                mActiveImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (item.mActive.equals("true")) {
                            ...
                            cancelAlarm(com.ecnu.plantyclock.Clock.activity.MainActivity.this, CheckedAlarmID, alarmModel);
                            Toast.makeText(com.ecnu.plantyclock.Clock.activity.MainActivity.this, "已关闭闹钟", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(com.ecnu.plantyclock.Clock.activity.MainActivity.this, "已开启闹钟", Toast.LENGTH_SHORT).show();
    ...
    private void selectAlarm(int id) {
        ...
        Intent intent = new Intent(this, com.ecnu.plantyclock.Clock.activity.EditAlarmActivity.class);
