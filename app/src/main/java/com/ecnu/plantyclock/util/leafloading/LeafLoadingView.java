...
public class LeafLoadingView extends View {
    ...
    // 橙色
    private static final int ORANGE_COLOR = 0x808000;//0x000080
    // 中等振幅大小
    ...
    public LeafLoadingView(Context context, AttributeSet attrs) {
        ...
        mLeftMargin = com.ecnu.plantyclock.util.leafloading.UiUtils.dipToPx(context, LEFT_MARGIN);
        mRightMargin = com.ecnu.plantyclock.util.leafloading.UiUtils.dipToPx(context, RIGHT_MARGIN);
