 ...
 * Use for 天气功能测试，然后转为fragment嵌套入styleactivity中
 */
public class weatheractivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView test1=(TextView)findViewById(R.id.foot_tv1);
        Typeface typeface1= Typeface.createFromAsset(getAssets(),"fonts/wawati.TTF");
        test1.setTypeface(typeface1);
        TextView test2=(TextView)findViewById(R.id.foot_tv2);
        Typeface typeface2= Typeface.createFromAsset(getAssets(),"fonts/wawati.TTF");
        test2.setTypeface(typeface2);
        TextView test3=(TextView)findViewById(R.id.foot_tv3);
        Typeface typeface3= Typeface.createFromAsset(getAssets(),"fonts/wawati.TTF");
        test3.setTypeface(typeface3);
        TextView test4=(TextView)findViewById(R.id.foot_tv4);
        Typeface typeface4= Typeface.createFromAsset(getAssets(),"fonts/wawati.TTF");
        test4.setTypeface(typeface4);
        TextView test5=(TextView)findViewById(R.id.foot_tv5);
        Typeface typeface5= Typeface.createFromAsset(getAssets(),"fonts/wawati.TTF");
        test5.setTypeface(typeface5);
        TextView test6=(TextView)findViewById(R.id.foot_tv6);
        Typeface typeface6= Typeface.createFromAsset(getAssets(),"fonts/wawati.TTF");
        ...
        tv_cityName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyDialog myDialog = new MyDialog(com.ecnu.plantyclock.Weather.weatheractivity.this);
                myDialog.show();
            }
        });
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                if(weatherBean.getResult().getHeWeather5().get(0).getStatus().equals("unknown location")){
                    Toast.makeText(com.ecnu.plantyclock.Weather.weatheractivity.this, "输入城市有误", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Toast.makeText(com.ecnu.plantyclock.Weather.weatheractivity.this, "更新时间" + weatherBean.getResult().getHeWeather5().get(0).getBasic().getUpdate().getLoc(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(com.ecnu.plantyclock.Weather.weatheractivity.this, "网络有误", Toast.LENGTH_SHORT).show();
                refreshLayout.setRefreshing(false);
            }
        });
            ...
            btn_chaxun.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (editText.getText().toString().equals("")) {
                        Toast.makeText(com.ecnu.plantyclock.Weather.weatheractivity.this, "输入为空,重新输入", Toast.LENGTH_SHORT).show();
                    } else {
